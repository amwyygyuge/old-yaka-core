...
export class Yaka extends Component {
	...
	componentWillReceiveProps = nextProps => {
		...
		if (
			debug &&
			(nextProps.config.length !== this.props.config.length ||
	...
	functionsWalk = (initFunctions = {}) => {
		Object.assign(this.functions, functions(initFunctions, this.yakaApis))
	}

	// 数据模型绑定和运行
	modelWalk = (initModels = {}) => {
		Object.assign(this.functions, models(initModels, this.yakaApis))
	}
